...
<div>
  ...
  <ul class="tree" style="margin: 3px; padding: 0px;">
	...
	<c:if test="${empty loginInfo}">
        <li style="list-style-type: disc; list-style-position: inside;">
          <a href="<c:url value="/public/index.html"/>">
            <span style="${(fn:contains(url, 'principal'))? "font-weight: bold;" : ""}">PUBLIC: Start page</span>
          </a>
        </li>        
	</c:if>
	...
	<c:if test="${not empty loginInfo}">
	    <li style="list-style-type: disc; list-style-position: inside;">
	      <a href="<c:url value="/common/principal.html"/>">
	        <span style="${(fn:contains(url, 'principal'))? "font-weight: bold;" : ""}">COMMON: Start page</span>
	      </a>
	    </li>
   ...
   <sec:authorize access="hasAnyRole('ROLE_SOLI', 'ROLE_DEST', 'ROLE_COLA', 'ROLE_DELE')">
    ...
    <hr  style="margin-top: 6px;  margin-bottom: 6px;" />
    <li style="list-style-type: disc; list-style-position: inside;">
      <a href="<c:url value="/public/instanciagenerica/new"/>">
        <span style="${(fn:contains(url, 'instnaciagenerica/new'))? "font-weight: bold;" : ""}">PUBLIC: Afegir instancia</span>
      </a>
    </li>
