 ...
 *
 */
public class InstanciaGenericaSessionLocaleResolver extends SessionLocaleResolver{
	...
	protected Locale determineDefaultLocale(HttpServletRequest request) {
		...
		try {
			...
			if (idioma == null) {
            idioma = org.fundaciobit.instanciagenerica.commons.utils.Configuracio.getDefaultLanguage();
			}
