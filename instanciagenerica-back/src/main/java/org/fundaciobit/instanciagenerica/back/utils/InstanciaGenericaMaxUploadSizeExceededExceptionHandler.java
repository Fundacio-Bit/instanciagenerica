 ...
 * 
 */
public class InstanciaGenericaMaxUploadSizeExceededExceptionHandler implements
  ...
  public ModelAndView resolveException(HttpServletRequest request,
    ...
    if (ex instanceof InstanciaGenericaMaxUploadSizeExceededException
      ...
      if (ex instanceof MaxUploadSizeExceededException) {
        ...
        if (musee instanceof InstanciaGenericaMaxUploadSizeExceededException) {
          msgCode = ((InstanciaGenericaMaxUploadSizeExceededException) musee).getMsgCode();
        } else {
