 ...
 */
@Component
public class InstanciaGenericaCommonsMultipartResolver extends
    org.springframework.web.multipart.commons.CommonsMultipartResolver {

  protected final Logger log = Logger.getLogger(getClass());

  public InstanciaGenericaCommonsMultipartResolver() {
    super();
  }
  ...
  public MultipartHttpServletRequest resolveMultipart(HttpServletRequest request)
	...
	*/
    ...
    try {
      ...
      throw new InstanciaGenericaMaxUploadSizeExceededException(musee.getCause(),
