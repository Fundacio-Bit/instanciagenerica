package org.fundaciobit.instanciagenerica.back.config;
 ...
 */
@Configuration
@ComponentScan(basePackages = {"org.fundaciobit.instanciagenerica"})
@EnableWebMvc
public class MvcConfiguration extends WebMvcConfigurerAdapter {
	...
	public LocaleResolver localeResolver() {
	    SessionLocaleResolver slr = new org.fundaciobit.instanciagenerica.back.utils.InstanciaGenericaSessionLocaleResolver();
	...
	public BeanPostProcessor beanPostProcessor() {
	    return new org.fundaciobit.instanciagenerica.back.security.DefaultRolesPrefixPostProcessor();
	}

	@Bean
	public MultipartResolver multipartResolver() {
		return new org.fundaciobit.instanciagenerica.back.utils.InstanciaGenericaCommonsMultipartResolver();
	}

	@Bean
	public HandlerExceptionResolver getFileSizeExceeds() {
	  return new org.fundaciobit.instanciagenerica.back.utils.InstanciaGenericaMaxUploadSizeExceededExceptionHandler();
	}
	...
	public MessageSource messageSource() {
		...
		messageSource.addBasenames("/WEB-INF/classes/missatges", "/WEB-INF/classes/logicmissatges",
				"/WEB-INF/classes/instanciagenerica_genapp", "/WEB-INF/classes/genapp");
