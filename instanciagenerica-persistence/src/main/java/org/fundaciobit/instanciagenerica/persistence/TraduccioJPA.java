...
private static final long serialVersionUID = -326205279L;
  ...
  public void setTraduccions(Map<String, org.fundaciobit.instanciagenerica.persistence.TraduccioMapJPA> _traduccions_) {
  ...
  public org.fundaciobit.instanciagenerica.persistence.TraduccioMapJPA getTraduccio(String idioma) {
    return (org.fundaciobit.instanciagenerica.persistence.TraduccioMapJPA) traduccions.get(idioma);
  }
  
  public void addTraduccio(String idioma, org.fundaciobit.instanciagenerica.persistence.TraduccioMapJPA traduccio) {
    if (traduccio == null) {
