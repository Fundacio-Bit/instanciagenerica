...
@Table(name = "ige_idioma" , indexes = { 
        @Index(name="ige_idioma_pk_i", columnList = "idiomaid")})
@SequenceGenerator(name="IDIOMA_SEQ", sequenceName="ige_idioma_seq", allocationSize=1, initialValue=1000)
...
// EXP  Field:idiomaid | Table: ige_instanciagenerica | Type: 0  
 ...
 // ---------------  STATIC METHODS ------------------
  ...
  static IdiomaJPA copyJPA(IdiomaJPA __jpa,
    ...
    if(!"InstanciaGenericaJPA".equals(origenJPA) 
      ...
      __tmp.setInstanciaGenericas(InstanciaGenericaJPA.copyJPA(__jpa.getInstanciaGenericas(), __alreadyCopied,"IdiomaJPA"));
    }
